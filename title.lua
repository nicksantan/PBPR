...
function scene:createScene( event )
	...
	local titleScreen = display.newImage("newtitle.png",0,0);
	
	-- create some text
	local title = display.newRetinaText( "MAIN SCREEN SUCKA", 0, 0, native.systemFont, 32 )
